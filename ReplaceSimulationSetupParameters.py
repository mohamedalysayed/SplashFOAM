...
# Amazing! This is an idea for making things appear in the main window of Splash!=====================> 
##class ReplaceSimulationSetupParameters:
##    def __init__(self, parent, constant_params, system_params, existing_values):
##        self.parent = parent
##        self.constant_params = constant_params
...
##        self.main_frame = ttk.Frame(parent.root)
##        self.main_frame.grid(row=0, column=0, padx=10, pady=10)

##        # Create a LabelFrame for "Constant Parameters"
...
##        # Create a LabelFrame for "System Parameters"
...
##        # Create a LabelFrame for "Injection/Combustion Simulation"
...
##        fuel_options = ["Option 1", "Option 2", "Option 3"]
##        
...
##        # Show a confirmation popup
##        confirmation = messagebox.askyesno("Simulation Setup", "Configure simulation setup parameters?")
##        if confirmation:
##            self.update_button = ttk.Button(self.main_frame, text="Update", command=self.update_simulation_setup_parameters)
##            self.update_button.grid(row=2, column=0, columnspan=2, pady=10)
##        else:
##            messagebox.showinfo("Process Canceled", "No changes were made.")
