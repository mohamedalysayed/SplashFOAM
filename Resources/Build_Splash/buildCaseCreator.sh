...
#~ ensure_python_env() {
    #~ echo "Ensuring Python environment compatibility..."
...
#~ ensure_dependencies() {
    ...
    #~ for MODULE in "${REQUIRED_MODULES[@]}"; do
        #~ if ! python3 -c "import $MODULE" &>/dev/null; then
            #~ echo "$MODULE is not installed. Installing it now..."
            #~ pip install "$MODULE"
        #~ fi
    #~ done
...
#~ test_vtk_qt() {
    #~ echo "Testing VTK and vtk.qt compatibility..."
    #~ python3 -c "
#~ try:
...
#~ validate_build() {
    ...
    #~ if [ -f "dist/$OUTPUT_NAME/$OUTPUT_NAME" ]; then
        ...
        #~ echo " Executable is located in the 'dist/$OUTPUT_NAME/' directory."
        #~ echo "================================================="
    #~ else
        #~ echo "================================================="
...
#~ # Main execution flow
#~ echo "================================================="
#~ echo " Starting the build process for $OUTPUT_NAME"
#~ echo "================================================="
