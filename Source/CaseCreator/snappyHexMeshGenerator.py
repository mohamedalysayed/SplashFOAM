...
{{
    ...
    locationInMesh ({meshSettings['castellatedMeshControls']['locationInMesh'][0]:.3f} {meshSettings['castellatedMeshControls']['locationInMesh'][1]:.3f} {meshSettings['castellatedMeshControls']['locationInMesh'][2]:.3f});
